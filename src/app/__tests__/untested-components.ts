...
export const UNTESTED_COMPONENTS: string[] = [
  ...
  'components/posts/review/draft-rail.tsx',
  'components/posts/review/insight-panel.tsx',
  'components/posts/review/schedule-dialog.tsx',
  'components/posts/review/work-column.tsx',
  'components/providers/auth-provider.tsx',
  'components/scheduling/batch-schedule-modal.tsx',
  'components/ui/image-lightbox.tsx',
  'features/analytics/components/ai-summary-strip.tsx',
  'features/analytics/components/analytics-loading.tsx',
  'features/analytics/components/analytics-view.tsx',
  'features/analytics/components/report-history.tsx',
  ...
  'features/publishing/components/canva-design-picker.tsx',
  'features/publishing/components/image-slot.tsx',
