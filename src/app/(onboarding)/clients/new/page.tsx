...
import type { OnboardingStep, OnboardProfile, Message } from '@/types/onboarding'
import { QUESTIONS, getDetectedAnswer } from '@/lib/onboarding/questions'
...
import { StepInterview } from '@/components/onboarding/step-interview'
