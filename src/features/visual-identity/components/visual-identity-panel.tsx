...
import { getBrandStyle, type BrandFontChoice, type BrandStyleId } from '@/lib/visual/brand-styles'
...
import { BrandStylePicker } from './brand-style-picker'
    ...
    <div className="flex flex-col gap-5">
      <div>
        ...
        <div className="max-w-[560px]">
          <BrandStylePicker value={identity.style} onChange={setStyle} />
        </div>
      </div>
