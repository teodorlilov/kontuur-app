 ...
 * email to the workspace's admins; a redelivered tick writes and mails nothing. Spends nothing.
 */
export async function GET(request: NextRequest) {
  ...
  try {
    const result = await remindTrialWorkspaces(createAdminSupabaseClient())
