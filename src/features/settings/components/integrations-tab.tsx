  ...
  return (
    <>
      <FormSection>
        <div className="col-span-12 flex items-center gap-3.5 py-[15px]">
          ...
          <div className="min-w-0 flex-1">
            <b className="block text-body font-semibold text-ink">Canva</b>
      ...
      >
        ...
        <p className="col-span-12 rounded-panel bg-wash px-4 py-3.5 text-caption leading-relaxed text-text2">
