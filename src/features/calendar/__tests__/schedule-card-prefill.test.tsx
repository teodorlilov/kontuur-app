 ...
 */
vi.mock('@/features/publishing/hooks/use-canva-status', () => ({
...
vi.mock('@/features/publishing/hooks/use-generate-visuals', () => ({
  useGenerateVisuals: () => ({
...
vi.mock('@/features/publishing/components/image-slot', () => ({
