  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{ color: 'var(--spring-text)', letterSpacing: '8px', marginTop: '6px' }}
          >
            SOCIAL INTELLIGENCE
          </div>
        </div>
      ...
      >
        ...
        <div
          className="flex lg:hidden mb-10 inline-block"
          style={{
            borderLeft: '1.5px solid var(--spring-text)',
            borderRight: '1.5px solid var(--spring-text)',
        ...
        >
          ...
          <div
            className="text-label"
            style={{ color: 'var(--spring-text)', letterSpacing: '6px', marginTop: '4px' }}
          >
            SOCIAL INTELLIGENCE
          </div>
        </div>
