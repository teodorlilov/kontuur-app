 ...
 * height check in the editor, a stub in tests. If it never fits, the outcome is `overflow` (the
 * caller must NOT clip — overflow is surfaced as a warning badge, per PRD §6.2).
 */
