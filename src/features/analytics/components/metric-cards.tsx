...
export function MetricCards({ metrics }: MetricCardsProps) {
  ...
  const cards = [
    { label: 'Reach', value: summary.total_reach.toLocaleString(), deltaPct: summary.reach_delta_pct },
    { label: 'Views', value: summary.total_impressions.toLocaleString(), deltaPct: summary.views_delta_pct },
    {
    ...
    { label: 'New followers', value: `+${summary.new_followers.toLocaleString()}`, deltaPct: summary.followers_delta_pct },
    { label: 'Follower growth rate', value: followerGrowthRate !== null ? `+${followerGrowthRate}%` : '—', deltaPct: null },
    { label: 'Frequency', value: frequency !== null ? `${frequency}x` : '—', deltaPct: null },
  ]

  if (!isIG && metrics.summary.organic_reach_pct != null) {
    cards.push({ label: 'Organic reach', value: `${metrics.summary.organic_reach_pct}%`, deltaPct: null })
  }
